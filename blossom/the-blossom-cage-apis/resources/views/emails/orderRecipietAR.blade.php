                                                ...
                                                <table border="0" cellpadding="0" cellspacing="0"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="logo" width="150" align="left"
                                                            style="line-height: 0px;">
                                                            <a href="http://www.Blossomcage.com/ar/contact"
                                    ...
                                    <table style="margin:0;width:100%;" cellpadding="0" cellspacing="0" border="0"
                                        ...
                                        <tr>
                                            <td width="100%" valign="top"
                                                ...
                                                height="30"><strong>
                                                    العزيز,{{$data['order']['recipient_first_name']}} {{$data['order']['recipient_last_name']}}</strong>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="fxfont1" height="40" width="100%" valign="top"
                                                ...
                                                @elseif($data['order']['order_status_id'] == 2)
                                                    طلبك قيد المعالجة لإرساله ورقم طلبك
                                                    هو:{{$data['order']['order_token']}}
                                        ...
                                        <tr>
                                            ...
                                            <td style="margin: 0; margin-bottom: 0; margin: 0 !important; margin-bottom: 0 !important;"
                                                    ...
                                                    <tr>
                                                        <td style="margin: 0; margin-bottom: 0; text-align: right;letter-spacing: .5px;padding:10px 15px!important; margin: 0 !important; vertical-align:middle; vertical-align: middle;margin-bottom: 0 !important;color:#444;font-family:'Quicksand', 'Arial', 'Helvetica', 'sans-serif';text-decoration:none;font-size:14px;font-weight:400;"
                                                            ...
                                                            <strong>هاتف:</strong> <strong
                                                                style="font-weight: normal;direction: ltr;text-align: right;display: inline-block;">{{$data['order']['recipient_phone_no']}} </strong>
                                                        </td>
                                                    </tr>
                                                    </tbody>
                                                </table>
                                                ...
                                                <table align="center" cellpadding="0" cellspacing="0" border="0"
                                                    ...
                                                    <?php  $data_city = \App\Cities::where('id', $data['shipping_address']['city'])->where('archive', 0)->first();
                                                ...
                                                <table align="center" cellpadding="0" cellspacing="0" border="0"
                                                    ...
                                                    <tr>
                                                        <td style="margin: 0; margin-bottom: 0; text-align: right;letter-spacing: .5px;padding:10px 15px!important; margin: 0 !important; vertical-align:middle; vertical-align: middle;margin-bottom: 0 !important;color:#444;font-family:'Quicksand', 'Arial', 'Helvetica', 'sans-serif';text-decoration:none;font-size:14px;font-weight:400;"
                                                            align="left" width="100%">
                                                            <strong>هاتف:</strong> <strong style="font-weight: normal;direction: ltr;text-align: right;display: inline-block;">{{$data['billing_address']['phone_no']}}</strong>
                                                        </td>
                                                    </tr>
                                                    </tbody>
                                                </table>
                                                ...
                                                <table align="center" cellpadding="0" cellspacing="0" border="0"
                                                    ...
                                                    <tr>
                                                        <td bgcolor="#E9ECEF"
                                                            ...
                                                            align="right" width="100%">طريقة الدفع او السداد
                                                        </td>
                                                    </tr>
                                                    </tbody>
                                                </table>
                                                    ...
                                                    <tr>
                                                        <td style="margin: 0; margin-bottom: 0; margin: 0 !important;text-align: right; vertical-align:top; margin-bottom: 0 !important;"
                                                            align="left" width="100%"><p
                                                                ...
                                                                : <span
                                                                    style="color:#444;font-family:'Arial', 'Arial', 'Helvetica', 'sans-serif';text-decoration:none;font-size:14px;font-weight:300; vertical-align:top; margin:0!important; font-style:italic">
                                                    ...
                                                    <table align="center" cellpadding="0" cellspacing="0" border="0"
                                                        ...
                                                        <tr>
                                                            <td style="margin: 0; margin-bottom: 0;text-align: right; letter-spacing: .5px;padding:10px 15px!important; margin: 0 !important; vertical-align:middle; vertical-align: middle;margin-bottom: 0 !important;color:#444;font-family:'Quicksand', 'Arial', 'Helvetica', 'sans-serif';text-decoration:none;font-size:14px;font-weight:400;"
                                                                ...
                                                                {{$data['order']['last_4_digits']}} ********   {{$data['order']['first_4_digits']}}
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td style="margin: 0; margin-bottom: 0; margin: 0 !important; vertical-align:top; margin-bottom: 0 !important;color:#627A76;font-family:'Quicksand', 'Arial', 'Helvetica', 'sans-serif'; line-height: 25px; text-decoration:none;font-size:14px;font-weight:bold; vertical-align:middle;"
                                                                            ...
                                                                            @if(!empty($item['color_code']))
                                                                                ...
                                                                                <span
                                                                                    style="color:#444;font-family:'Quicksand', 'Arial', 'Helvetica', 'sans-serif';text-decoration:none;font-size:14px;margin:0!important; font-weight: bold; ">
                                                                                <strong
                                                                            ...
                                                                            <span
                                                                                style="width:100%; display: block; text-align: left; color:#444;font-family:'Quicksand', 'Arial', 'Helvetica', 'sans-serif';text-decoration:none;font-size:18px;margin:0!important; font-weight: normal; "> {{$item['currency']}} {{$item['price']}}</span>
                                                                        ...
                                                                        <table align="center" cellpadding="0"
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td style="margin: 0; margin-bottom: 0; margin: 0 !important; vertical-align:top; margin-bottom: 0 !important;color:#627A76;font-family:'Quicksand', 'Arial', 'Helvetica', 'sans-serif';text-decoration:none;font-size:14px;font-weight:bold; vertical-align:middle;"
                                                                                    ...
                                                                                    <br>
                                                                                    <span
                                                                                        style="color:#444;font-family:'Quicksand', 'Arial', 'Helvetica', 'sans-serif';text-decoration:none;font-size:13px;margin:0!important; font-weight: normal; "> Quantity: <strong>{{  $accessorieQty}}</strong></span>
                                                                                    <br>
                                                                                    <span
                                                                                        style="width:100%; display: block; text-align: left; color:#444;font-family:'Quicksand', 'Arial', 'Helvetica', 'sans-serif';text-decoration:none;font-size:18px;margin:0!important; font-weight: normal; "> {{$item['currency']}} {{$orderItemAccessoire['price']}}</span>
                                                            ...
                                                            <table width="100%" border="0" class="footer"
                                                                ...
                                                                <tr>
                                                                    <td style=" text-align: center; font-size: 11px;">
                                                                        <a href="http://www.Blossomcage.com/ar/about"
                                                                        ...
                                                                        <a href="http://www.Blossomcage.com/ar/about"
                                                                           style="text-decoration: none;color: #000;line-height: 30px;font-family: 'Quicksand' , arial; font-weight:500 ;font-size: 14px;">الأحكام
                                                                            والشروط</a> |
                                                                        <a href="http://www.Blossomcage.com/ar/privacy"
