...
class PaytabsServies extends Config {
    ...
    public function storeTransactionData($request)
    {
        try {
            ...
            $order =  $this->getOrderModel()->where('order_token', $request_params['order_id'])->first();
            ...
            $update_order_ipn_response = DB::table('ipn_response')->insert($transaction_data);
