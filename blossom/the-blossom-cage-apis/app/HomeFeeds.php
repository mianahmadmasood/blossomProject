...
class HomeFeeds extends Model {
    ...
    public function getnewHomefeeds() {
    ...
    public function getnewHomefeedsForBrand() {

       return $this->whereHas('brand', function ($sql) {
               $sql->where('archive', 0);
           })
            ->where('archive', 0)
            ->where('status', 0)
...
//            ->take(10)
    ...
    public function getHomefeedstrendyItem($searchText) {
        return $this->where('archive', 0)
            ->where('type', $searchText)
            ->orderBy('ordering_sort', 'ASC')
            ->where('archive', 0)
