                ...
                <div class="kt-portlet__head">
                    <div class="kt-portlet__head-label">
                        <h3 class="kt-portlet__head-title">
                            ...
                            @else
                            <img height="50" width="50" class="img-rounded" src="{{asset('public/theme-images/user.png')}}" alt="">
                            @endif
                ...
                <div class="kt-portlet__body">
                    <div class="kt-widget12">
                        <div class="kt-widget12__content">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <span class="kt-widget12__desc bbold">My Current Orders</span> <br>
                                    <span>{{count($pending_assignments)}}</span>
                                </div>
                                <div class="col-md-4">
                                    <span class="kt-widget12__desc bbold">My Completed Orders</span> <br>
