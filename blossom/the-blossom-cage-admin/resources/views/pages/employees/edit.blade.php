...
<div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor">
    ...
    <div class="kt-subheader   kt-grid__item" id="kt_subheader">
        <div class="kt-subheader__main">
            <h3 class="kt-subheader__title"> Update Employee Account</h3>
            <span class="kt-subheader__separator kt-hidden"></span>
            <div class="kt-subheader__breadcrumbs">
                <a href="#" class="kt-subheader__breadcrumbs-home"><i class="flaticon2-shelter"></i></a>
                <span class="kt-subheader__breadcrumbs-separator"></span>
                <a href="{{route('allEmployees')}}" class="kt-subheader__breadcrumbs-link">
                    Employee
                </a>
                <span class="kt-subheader__breadcrumbs-separator"></span>
                <a href="{{route('editEmployee', ['id' => $employee['uuid']])}}" class="kt-subheader__breadcrumbs-link">
                    Update Account
                </a>
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="kt-portlet">
                    ...
                    <!--begin::Form-->
                    <form class="kt-form kt-form--fit kt-form--label-right" action="{{route('updateEmployee')}}" enctype="multipart/form-data" method="post">
                        @csrf
                        <div class="kt-portlet__body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-3">
                                    <input type="text" maxlength="45" class="form-control" placeholder="Enter employee first name..." name="first_name" value = "{{ $employee['first_name'] }}"  >
                                ...
                                <div class="col-lg-3">
                                    <input type="text" maxlength="45" class="form-control" placeholder="Enter employee last name..." name="last_name" value = "{{ $employee['last_name']  }}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-3 float-lg-right">
                                    <input  class="form-control"  placeholder="Enter employee contact number.." name="phone_no" value = "{{ isset($employee['nationNumber'])?$employee['nationNumber']:$employee['phone_no']  }}"   type="number" min="0" oninput="validity.valid||(value='');" pattern="^[0-9]"  onKeyPress="if(this.value.length==15) return false;"     >

                                    @if(!isset($employee['nationNumber']))
                                    <span class="form-text text-muted" style="color: red !important; "> Your perviosly edit phone number is <b>( {{$employee['phone_no']}} )</b>  incorrect.Plese enter Valid phone number</span>
                                   @endif
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-3">
                                    ...
                                    <span class="form-text text-muted" style="color: red !important; ">Current Employee password will be changed after updating this field. </span>
                            ...
                            <div class="form-group row">
                                ...
                                @else
                                    <label class="col-lg-2 col-form-label">Existing Image:</label>
                                    <div class="col-lg-3">
                                        <img id="prevEmployeesImage"  style="padding-top: 10px !important;" height="257"
                                             width="257" alt="No Image" src="{{config('paths.home_url') . 'thumbnails/medium/profile-images/' .  $employee['image']}}">
                                    </div>
