                    ...
                    <div class="kt-portlet__head">
                        <div class="kt-portlet__head-label">
                            <h3 class="kt-portlet__head-title">
                                Accessories Information Schema
                            </h3>
                        </div>
                    </div>
                    <!--begin::Form-->
                    <form class="kt-form kt-form--fit kt-form--label-right" action="{{route('storeaccessorie')}}"
                        ...
                        <div class="kt-portlet__body">
                            <div class="form-group row">
                                ...
                                <div class="col-lg-3">
                                    <input type="text" class="form-control" placeholder="Enter accessorie title"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-4">
                                    <input type="number" class="form-control" placeholder="Enter product price" name="price" value = "{{ old('price') }}" oninput="validity.valid||(value='');" min="0" step="any"  onKeyPress="if (this.value.length == 9)
                                                return false;"  >
                            ...
                            <div class="form-group row">
                                ...
                                @if(old('image') !== null)
                                    <img id="prevAccessoriesImage" style="padding-top: 10px !important;" height="257"
                                         width="257"
                                         alt="No Image" src="{{config('paths.home_url') . config('paths.medium-accessories-thumb') . old('image')}}"
                                    />
                        ...
                        <div class="kt-portlet__foot kt-portlet__foot--fit-x">
                            <div class="kt-form__actions">
                                <div class="row">
                                    ...
                                    <div class="col-lg-4">
                                        <button type="submit" id="fileAccessorie" class="btn btn-success">Submit</button>
