            ...
            <div class="kt-portlet__head-toolbar">
                <div class="kt-portlet__head-wrapper">
                    <div class="kt-portlet__head-actions">
                        ...
                        <a href="{{route(('createItem'))}}" class="btn btn-brand btn-elevate btn-icon-sm">
                        ...
                        @foreach($items as $key=> $item)
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <br>
                                    <br>
                                    <a style="text-decoration: underline;" href="{{route('removed', ['key' => 'remove','uid' => $item->uuid])}}"class="la la-trash alterConfirmMassageForProduct">Delete Product</a>
                                </td>
                            </tr>
                        @endforeach
                </tbody>
