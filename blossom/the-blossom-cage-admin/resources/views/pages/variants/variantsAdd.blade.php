                        ...
                        <form id="variant_form" class="kt-form kt-form--fit kt-form--label-right"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-2">
                                        ...
                                        <select id="orientation_unit" style=" width: 100%;"
                                            ...
                                            <option value="mm-مم"> mm - مم</option>
                                        </select>
                            ...
                            <div class="kt-portlet__body">
                                <div class="form-group row">
                                    <div class="col-md-2">
                                        ...
                                        <input id="unit_of_power_value" type="number" class="form-control" minlength="0"
                                               placeholder="Power value" name="unit_of_power[value]" maxlength="45">
                            ...
                            <div class="kt-portlet__body">
                                ...
                                @foreach($colors as $color)
                                    <?php $counter++; ?>
                                    <div id="color_{{$counter}}" @if($counter != 1) style="display: none" @endif>
                                        @include('partials.variantItemColor')
                                    </div>
                                @endforeach
                                <div class="form-group row">
                                    <div class="col-lg-2">
                                        <input type="hidden" id="counter" value="2" data-max="{{$counter}}">
                                        <button id="submit_item_color_add" type="button" class="btn btn-success">Add
                                            more
                                        </button>
                                    </div>
                                </div>
                                ...
                                <div class="kt-portlet__foot kt-portlet__foot--fit-x">
                                    <div class="kt-form__actions">
                                        <div class="row">
                                            ...
                                            <div class="col-md-3"></div>
                                            <div class="col-md-3 ">
                                                <button id="submit_form" type="submit" class="btn btn-success">Submit
                                                </button>
