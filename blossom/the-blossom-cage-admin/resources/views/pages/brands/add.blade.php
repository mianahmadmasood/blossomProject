                    ...
                    <div class="kt-portlet__head">
                        <div class="kt-portlet__head-label">
                            <h3 class="kt-portlet__head-title">
                                Brands Information Schema
                            </h3>
                        </div>
                    </div>
                    <!--begin::Form-->
                    <form class="kt-form kt-form--fit kt-form--label-right" action="{{route('storebrand')}}"
                        ...
                        <div class="kt-portlet__body">
                            <div class="form-group row">
                                ...
                                <div class="col-lg-3">
                                    <input type="text" class="form-control" placeholder="Enter brand title"
                            ...
                            <div class="form-group row">
                                ...
                                @if(old('image') !== null)
                                    <img id="prevBrandsImage" style="padding-top: 10px !important;" height="257"
                                         width="257"
                                         alt="No Image" src="{{config('paths.home_url') . config('paths.medium-brands-thumb') . old('image')}}"
                                    />
