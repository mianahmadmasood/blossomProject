            ...
            <div class="kt-portlet__head-toolbar">
                <div class="kt-portlet__head-wrapper">
                    <div class="kt-portlet__head-actions">
                        &nbsp;
                        <a href="{{route('createbrand')}}" class="btn btn-brand btn-elevate btn-icon-sm">
...
{{--                        <th>Products List</th>--}}
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        @if(!empty($brand->image))
                            <td> <img class="imagSize" src="{{config('paths.home_url') . 'thumbnails/large/brands/' . $image}}"></td>
                        @else
                            <td> <img class="imagSize" src="{{config('paths.home_url') . 'thumbnails/large/categories/' . $image}}"></td>
                        @endif

{{--                        <td> <a href="{{route('getCategoryItems', ['uuid' => $brand->uuid])}}"> <i class="fa fa-eye"> </i> View Products</a></td>--}}
                        <td>
                            <a href="{{route('editBrand', ['uid' => $brand->uuid])}}">
                            ...
                            <br>
{{--                            @if($brand->status == 0)--}}
{{--                            <a href="{{route('updateStatusBrand', ['uid' => $brand->uuid,'status' => 'in-active'])}}">--}}
{{--                                <i class="la la-refresh">Active</i>--}}
{{--                            </a>--}}
{{--                            @else--}}
{{--                            <a href="{{route('updateStatusBrand', ['uid' => $brand->uuid,'status' => 'active'])}}">--}}
