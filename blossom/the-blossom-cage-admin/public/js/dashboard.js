            ...
            !function () {
                ...
                colors: [KTApp.getStateColor("success"), KTApp.getStateColor("brand"), KTApp.getStateColor("danger")]
                    ...
                    function () {
                        ...
                        function r(e, a, r) {
                            var o = "",
                                    l = "";
                            a - e < 100 || "Today" == r ? (o = "Today:", l = e.format("MMM D")) : "Yesterday" == r ? (o = "Yesterday:", l = e.format("MMM D")) : l = e.format("MMM D") + " - " + a.format("MMM D"), t.find(".kt-subheader__daterange-date").html(l), t.find(".kt-subheader__daterange-title").html(o)
                        }
                ...
                columns: [{
                        ...
                        template: function (t, e) {
                            ...
                            return a > 5 ? '<div class="kt-user-card-v2">\t\t\t\t\t\t\t<div class="kt-user-card-v2__pic">\t\t\t\t\t\t\t\t<img src="assets/media/users/' + r + '" alt="photo">\t\t\t\t\t\t\t</div>\t\t\t\t\t\t\t<div class="kt-user-card-v2__details">\t\t\t\t\t\t\t\t<a href="#" class="kt-user-card-v2__name">' + t.CompanyAgent + '</a>\t\t\t\t\t\t\t\t<span class="kt-user-card-v2__desc">' + l[o] + "</span>\t\t\t\t\t\t\t</div>\t\t\t\t\t\t</div>" : '<div class="kt-user-card-v2">\t\t\t\t\t\t\t<div class="kt-user-card-v2__pic">\t\t\t\t\t\t\t\t<div class="kt-badge kt-badge--xl kt-badge--' + ["success", "brand", "danger", "success", "warning", "primary", "info"][KTUtil.getRandomInt(0, 6)] + '">' + t.CompanyAgent.substring(0, 1) + '</div>\t\t\t\t\t\t\t</div>\t\t\t\t\t\t\t<div class="kt-user-card-v2__details">\t\t\t\t\t\t\t\t<a href="#" class="kt-user-card-v2__name">' + t.CompanyAgent + '</a>\t\t\t\t\t\t\t\t<span class="kt-user-card-v2__desc">' + l[o] + "</span>\t\t\t\t\t\t\t</div>\t\t\t\t\t\t</div>"
                        }
                    }, {
                        field: "Actions",
                        width: 80,
